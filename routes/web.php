...
Route::prefix('nelayan')->group(function () {
    ...
    Route::get('/pengaturan', [NelayanController::class, 'pengaturan'])->name('nelayan.pengaturan');
    route::post('/pengaturan/updatename', [NelayanController::class, 'updatenamenelayan'])->name('nelayan.updatename');
    route::post('/pengaturan/updatepassword', [NelayanController::class, 'newpasswordnelayan'])->name('nelayan.newpassword');
    Route::post('/updateBarangSewa/{kode_barang}', [NelayanController::class, 'updateBarangSewa'])->name('nealayan.updateBarangSewa');
    Route::post('/deleteBarangSewa/{kode_barang}', [NelayanController::class, 'deleteBarangSewa'])->name('nealayan.deleteBarangSewa');
});
