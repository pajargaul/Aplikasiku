            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Registrasi Akun Nelayan</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Registrasi Akun Nelayan</li>
                        </ol>
                    ...
                    <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{route('admin.storetambahnelayan')}}">
                                    @csrf
                                    <div class="mb-3 row">
                                  ...
                                  <div class="mb-3 row">
                                    <button style="width: 20%; margin-left:auto; margin-right:auto; margin-top:3%" type="submit" class="btn btn-danger">Daftarkan</button>
                                  </div>
                                  @if(session('st'))
