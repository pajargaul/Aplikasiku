...
<body style="background-image: url('img/bg.svg')">
    ...
    <div class="container-fluid p-0 mb-5">
        <div class="owl-carousel header-carousel position-relative">
                        ...
                        <div class="row justify-content-start">
                            <div class="col-sm-10 col-lg-8">
                                <h5 class="text-primary text-uppercase mb-3 animated slideInDown">Selamat Datang di
                                    FishApp</h5>
                                <h1 class="display-3 text-white animated slideInDown">Sahabat Terbaik para Nelayan!
                                </h1>
                                <p class="fs-5 text-white mb-4 pb-2">FishApp adalah solusi revolusioner untuk nelayan
                                    berbasis data, yang membantu Anda
                                ...
                                <a href="{{ route('userabout') }}"
                                    ...
                                    style="background-color: #097ABA">Selengkapnya</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-sm-10 col-lg-8">
                                <h5 class="text-primary text-uppercase mb-3 animated slideInDown">Selamat Datang di
                                    FishApp</h5>
                                <h1 class="display-3 text-white animated slideInDown">Menyediakan Informasi Mengenai
                                    Penyewaan Kapal dan Alat Penangkapan Ikan</h1>
                                <p class="fs-5 text-white mb-4 pb-2">Memantau Cuaca dan Suhu Air Real-Time: Kami
            ...
            <div class="owl-carousel-item position-relative">
                <img class="img-fluid"
                    src="img/kenapa-ikan-marlin-jadi-ikon-pangandaran-simak-penjelasannya-iw5zFU2TCB.jpeg"
                    alt="">
                <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center"
                    style="background: rgba(24, 29, 56, .7);">
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-sm-10 col-lg-8">
                                <h5 class="text-primary text-uppercase mb-3 animated slideInDown">Selamat Datang di
                                    FishApp</h5>
                                <h1 class="display-3 text-white animated slideInDown">Maksimalkan Hasil Tangkapan Ikan
                                    di Laut</h1>
                                <p class="fs-5 text-white mb-4 pb-2">FishApp membantu Anda meningkatkan efisiensi
                                    penangkapan ikan Anda,
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
                    <a href="{{ route('comingsonn') }}">
                        <div class="service-item text-center pt-3" style="border-radius:20px">
                            <div class="p-4">
                                <img src="{{ asset('img/toko.png') }}" alt=""
                                    style="width: 99%">
                ...
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.7s">
                    <a href="{{ route('comingsonn') }}">
                        <div class="service-item text-center pt-3" style="border-radius:20px">
                            <div class="p-4">
                                <img src="{{ asset('img/ikan2.png') }}" alt=""
                                    style="width: 99%">
                    ...
                    <div class="row g-3">
                        <div class="col-lg-12 col-md-12 wow zoomIn" data-wow-delay="0.1s">
                            <a class="position-relative d-block overflow-hidden" href="">
                                <img class="img-fluid"
                                    src="img/kkp-kembali-tangkap-kapal-nelayan-asing-berbendera-malaysia-kQIOFAL2zs.jpg"
                                    alt="">
                ...
                <div class="col-lg-5 col-md-6 wow zoomIn" data-wow-delay="0.7s" style="min-height: 350px;">
                    <a class="position-relative d-block h-100 overflow-hidden" href="">
                        <img class="img-fluid position-absolute w-100 h-100"
                            src="img/Nelayan-harus-mendapat-perlindungan-dari-negara.jpg" alt=""
